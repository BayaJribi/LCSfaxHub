...
function Stickers() {
    // Filter the data to only include elements with the category 'Stickers'
    const filteredData = ShopItems.filter(element => element.category === 'Stickers');

    return (
        <div className="container-fluid py-4 px-5 mb-5 secondary-Background-color">
            <div className="text-center mx-auto mb-5">
                <h1 className="display-5 mb-0">Stickers</h1>
