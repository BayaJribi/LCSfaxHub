...
function OGV() {
    // Filter the data to only include elements with the category 'OGV'
    const filteredData = frontOfficeData.filter(element => element.category === 'OGV');

    return (
        <div className="container-fluid py-4 px-5 secondary-Background-color">
            <div className="text-center mx-auto mb-5">
                <h1 className="display-5 mb-0">Outgoing Global Volunteer</h1>
